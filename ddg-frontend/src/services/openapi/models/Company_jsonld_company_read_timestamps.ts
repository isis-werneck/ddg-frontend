...
/* tslint:disable */
/* eslint-disable */
export type Company_jsonld_company_read_timestamps = {
    ...
    legalNature?: Company_jsonld_company_read_timestamps.legalNature;
    ...
    representativeNormativeBasis?: Company_jsonld_company_read_timestamps.representativeNormativeBasis;
    ...
    representativeNormativeBasis2?: Company_jsonld_company_read_timestamps.representativeNormativeBasis2;
    representativeAppointedBy2?: string | null;
    createdAt?: string;
    updatedAt?: string;
};
export namespace Company_jsonld_company_read_timestamps {
