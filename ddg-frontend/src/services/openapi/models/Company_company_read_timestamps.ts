...
/* tslint:disable */
/* eslint-disable */
export type Company_company_read_timestamps = {
    readonly id?: number;
    name: string;
    activity: string;
    ...
    legalNature?: Company_company_read_timestamps.legalNature;
    ...
    representativeNormativeBasis?: Company_company_read_timestamps.representativeNormativeBasis;
    ...
    representativeNormativeBasis2?: Company_company_read_timestamps.representativeNormativeBasis2;
    representativeAppointedBy2?: string | null;
    createdAt?: string;
    updatedAt?: string;
};
export namespace Company_company_read_timestamps {
