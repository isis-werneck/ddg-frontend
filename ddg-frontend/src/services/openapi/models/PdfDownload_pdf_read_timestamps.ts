...
import type { PdfLearningOutcome_pdf_read_timestamps } from './PdfLearningOutcome_pdf_read_timestamps';
import type { PdfSignatory_pdf_read_timestamps } from './PdfSignatory_pdf_read_timestamps';
import type { PdfStudent_pdf_read_timestamps } from './PdfStudent_pdf_read_timestamps';
/**
 * Generate a PDF file and stores received data to the database.
 */
export type PdfDownload_pdf_read_timestamps = {
    readonly id?: number;
    fileType: PdfDownload_pdf_read_timestamps.fileType;
    company?: string | null;
    trainingCycle?: string | null;
    course?: string | null;
    trainingAction?: string | null;
    students?: Array<PdfStudent_pdf_read_timestamps>;
    learningOutcomes?: Array<PdfLearningOutcome_pdf_read_timestamps>;
    signatory?: (PdfSignatory_pdf_read_timestamps | null);
...
export namespace PdfDownload_pdf_read_timestamps {
