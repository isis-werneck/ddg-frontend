...
/* tslint:disable */
/* eslint-disable */
export type Company_jsonld_company_write = {
    name: string;
    activity: string;
    ...
    legalNature?: Company_jsonld_company_write.legalNature;
    ...
    representativeNormativeBasis?: Company_jsonld_company_write.representativeNormativeBasis;
    ...
    representativeNormativeBasis2?: Company_jsonld_company_write.representativeNormativeBasis2;
    representativeAppointedBy2?: string | null;
};
export namespace Company_jsonld_company_write {
